...
devices.push(
  new Device({
    port,
    model: 'lb100',
    data: { alias: 'Mock LB100', mac: 'aa:aa:aa:49:ca:42', deviceId: 'BB100' },
  })
);
devices.push(
  new Device({
    port,
    model: 'lb120',
    data: { alias: 'Mock LB120', mac: 'aa:aa:aa:90:9b:da', deviceId: 'BB120' },
  })
);
devices.push(
  new Device({
    port,
    model: 'lb130',
    data: { alias: 'Mock LB130', mac: 'aa:aa:aa:b1:04:d3', deviceId: 'BB130' },
  })
);
