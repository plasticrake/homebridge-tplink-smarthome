...
class HomeKitDevicePlug extends HomeKitDevice {
  ...
  addBasicCharacteristics () {
    ...
    this.tplinkDevice.on('in-use', () => { this.fireCharacteristicUpdateCallback(Characteristic.OutletInUse, true); });
    this.tplinkDevice.on('not-in-use', () => { this.fireCharacteristicUpdateCallback(Characteristic.OutletInUse, false); });
  }
  /**
   * @private
   */
  ...
  addEnergyCharacteristics () {
    ...
    this.tplinkDevice.on('emeter-realtime-update', (emeterRealtime) => {
      this.fireCharacteristicUpdateCallback(CustomCharacteristic.Amperes, emeterRealtime.current);
      this.fireCharacteristicUpdateCallback(CustomCharacteristic.KilowattHours, emeterRealtime.total);
      this.fireCharacteristicUpdateCallback(CustomCharacteristic.VoltAmperes, emeterRealtime.voltage * emeterRealtime.current);
      this.fireCharacteristicUpdateCallback(CustomCharacteristic.Volts, emeterRealtime.voltage);
