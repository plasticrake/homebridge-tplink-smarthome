...
const configSetup = function () {
  ...
  c.deviceOptions = c.deviceOptions || {};
  c.deviceOptions.discoveryInterval = c.deviceOptions.discoveryInterval || c.pollingInterval * 1000 || 10000;
  c.deviceOptions.inUseThreshold = c.deviceOptions.inUseThreshold || c.inUseThreshold;
  c.deviceOptions.memoize = c.deviceOptions.memoize || c.cacheTtl * 1000 || null;
};
